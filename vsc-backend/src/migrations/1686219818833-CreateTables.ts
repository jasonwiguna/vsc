...
export class CreateTables1686219818833 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pricing_package" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "packageName" text NOT NULL, "monthlyPrice" double precision NOT NULL, "annualPrice" double precision NOT NULL, CONSTRAINT "pricing_package_pkey" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "subscription" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "pricingPackageId" uuid NOT NULL, "key" text NOT NULL, "monthly" boolean NOT NULL, "suspended" boolean NOT NULL DEFAULT false, "subscriptionDate" TIMESTAMP NOT NULL DEFAULT now(), "expirationDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "subscription_pkey" PRIMARY KEY ("id"))`);
